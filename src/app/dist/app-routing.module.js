...
var routes = [
    { path: '', component: find_component_1.FindComponent },
    { path: 'result', component: result_component_1.ResultComponent, canActivate: [authguard_service_1.AuthguardService] }
];
